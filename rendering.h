...
void set_pixel(SDL_Renderer *rend, int x, int y, int r, int g, int b, int a)
{
...
void draw_circle(SDL_Renderer *surface, int n_cx, int n_cy, int radius, const SDL_Color* color)
{
	...
	while (x >= y)
	{
		set_pixel(surface, (int)(cx + x), (int)(cy + y), color->r, color->g, color->b, 255);
		set_pixel(surface, (int)(cx + y), (int)(cy + x), color->r, color->g, color->b, 255);
